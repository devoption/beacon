...
class InstallCommand extends Command
{
    ...
    protected function displayConfigurationSummary(array $configuration): void
    {
        ...
        $this->components->twoColumnDetail('Runtime', (string) Arr::get($runtimeLabels, Arr::get($configuration, 'runtime'), 'Unknown'));
        $this->components->twoColumnDetail('Scaffolding', (string) Arr::get($deploymentLabels, Arr::get($configuration, 'deployment_target'), 'Unknown'));
